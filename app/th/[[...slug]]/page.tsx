...
const pages: Record<string, PageContent> = {
  ...
  "legal-notice": { eyebrow: "ข้อมูลทางกฎหมาย", title: "ข้อมูลผู้รับผิดชอบเว็บไซต์", intro: "ฉบับภาษาเยอรมันเป็นฉบับที่มีผลทางกฎหมาย ข้อความภาษาไทยนี้จัดทำขึ้นเพื่อช่วยให้เข้าใจข้อมูลเบื้องต้น", sections: [{ title: "ผู้ให้บริการ", text: "DIDE - Dhammakaya International Deutschland gemeinnützige GmbH — Heinkelstr. 1, 86343 Königsbrunn — Amtsgericht Augsburg, HRB 24820 — อีเมล: info@derwegnachinnen.de" }], cta: { label: "ดูฉบับภาษาเยอรมัน", href: "/impressum" } },
