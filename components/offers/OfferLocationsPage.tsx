        ...
        <Container>
          ...
          <FadeIn delay={0.12}>
            <div className="mt-14 rounded-[28px] border border-[#DED5C5] bg-[#EFE8DC] px-7 py-8 text-center sm:px-10">
              <h2 className="font-serif text-3xl text-[#153B36]">
                Sie möchten das Angebot an einem
                Standort anfragen?
              </h2>
          ...
          {contactForm && (
            <FadeIn delay={0.16}>
              <section
                id="anfrageformular"
                aria-labelledby="offer-request-form-heading"
                ...
                <div className="mx-auto max-w-4xl">
                  <div className="mb-10 text-center">
                    ...
                    <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-slate-600">
                      ...
                      Angaben zu Ihrer Schule oder
                      Gruppe mit. Wir prüfen Ihren
                      Terminwunsch und melden uns
                      persönlich bei Ihnen.
                    </p>
                  </div>

                  <div className="rounded-[32px] border border-[#E0DDD4] bg-white p-7 shadow-[0_24px_80px_rgba(21,59,54,0.08)] sm:p-10">
                    {contactForm}
                  </div>
                </div>
              </section>
